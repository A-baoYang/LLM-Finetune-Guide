...
num_train_epochs=5
max_seq_length=512
output_dir=/workspace/Code/LLM-Finetune-Guide/efficient-finetune/Chinese-LLaMA-2/lora/finetuned/sft-dcardwom-llama2_7b-lora-llama2_7b-lora-${lora_rank}-${lora_alpha}-${lora_dropout}-${lr}-${per_device_train_batch_size}-${num_train_epochs}-${gradient_accumulation_steps}-${block_size}
